...
(function() {
    ...
    function renderLogs(logs) {
        ...
        logs.forEach(function(log) {
            ...
            html += '<tr>' +
                    '<td><span class="log-reason-label type-' + reason.type + '">' + escapeHtml(reason.label) + '</span></td>' +
                    '<td>' + escapeHtml(log.time) + '</td>' +
                    '<td>' + escapeHtml(log.author) + '</td>' +
                    '<td>' + escapeHtml(log.mail) + '</td>' +
                    '<td><code>' + escapeHtml(log.ip) + '</code></td>' +
                    '<td><div class="log-comment-text">' + escapeHtml(log.text).replace(/\n/g, '<br>') + '</div></td>' +
                    '</tr>';
        });
